...
class UnidadesControllerTest < ActionController::TestCase
  ...
  test "should create unidade" do
    assert_difference('Unidade.count') do
      post :create, unidade: { bairro: @unidade.bairro, comochegar: @unidade.comochegar, endereco: @unidade.endereco, latitude: @unidade.latitude, longitude: @unidade.longitude, nome: @unidade.nome }
    end
  ...
  test "should update unidade" do
    patch :update, id: @unidade, unidade: { bairro: @unidade.bairro, comochegar: @unidade.comochegar, endereco: @unidade.endereco, latitude: @unidade.latitude, longitude: @unidade.longitude, nome: @unidade.nome }
    assert_redirected_to unidade_path(assigns(:unidade))
  end
